...
#define ESP32_CAN_TX_PIN GPIO_NUM_3 // If you use ESP32 and do not have TX on default IO 16, uncomment this and and modify definition to match your CAN TX pin.
#define ESP32_CAN_RX_PIN GPIO_NUM_1 // If you use ESP32 and do not have RX on default IO 4, uncomment this and and modify definition to match your CAN RX pin.
#define ESP32_MOD_RX_PIN GPIO_NUM_21  //modbus RX
#define ESP32_MOD_TX_PIN GPIO_NUM_20  //modbux TX
...
String getSensorReadings(){
  readings["awa"] = 120; //String(bme.readTemperature());
  readings["aws"] =  10; //String(bme.readHumidity());
...
void setup() {
  ...
  //modSerial.begin(115200, SERIAL_8N1, ESP32_MOD_RX_PIN, ESP32_MOD_TX_PIN);
